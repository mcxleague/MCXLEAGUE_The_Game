...
export const metadata: Metadata = {
  title: 'MCXLEAGUE | A minimalistic, customizable typing test',
  description:
    'One of the most customizable typing test website with a minimal design and a ton of features. Test yourself in various modes, track your progress and improve your speed.',
};
